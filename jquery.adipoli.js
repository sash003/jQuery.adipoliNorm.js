 ...
 */
(function($) {
  $.fn.adipoliNorm = function(options) {
    ...
    $this.one('load', function() {
      $(this).wrap(function() {
        return '<div class="adipoli-wrapper ' + $(this).attr('class') + '" style="width:' + o.w + '; height:' + o.h + ';"/>';
      });

      $(this).parent().append('<div class="adipoli-before ' + $(this).attr('class') + '" style="display:none;width:' + o.w + '; height:' + o.h + ';"><img src="' + $(this).attr('src') + '" style="width:' + o.w + '; height:' + o.h + ';"/></div>');
      $(this).parent().append('<div class="adipoli-after ' + $(this).attr('class') + '" style="display:none;width:' + o.w + '; height:' + o.h + ';"></div>');
      ...
      if (settings.startEffect == "transparent") {
        ...
        $this.siblings('.adipoli-before').children('img').each(function() {
      ...
      $this.parent().bind('mouseenter', function() {
        ...
        if (settings.hoverEffect == 'normal') {
          var element = $(this);
          element.children('.adipoli-after').html('<img src="' + element.children('img').attr('src') + '"  style="width: ' + o.w + '; height: ' + o.h + ';"/>').fadeIn(settings.animSpeed);
          /////
        } else if (settings.hoverEffect == 'popout') {
          element = $(this);

          var curImageWidth = parseInt(o.w);
          var curImageHeight = parseInt(o.h);
    ...
    */
    ...
    function grayscale(src) {
      ...
      imgObj.src = src;
      canvas.width = parseInt(o.w);
      canvas.height = parseInt(o.h);
